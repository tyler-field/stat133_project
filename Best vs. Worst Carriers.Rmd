...
Total.Delay.Percentage <- ggplot(Total.Delay.Percentage, aes(x=CARRIER, y=Total_Delay_Percentage, color=CarriersFlightFrequency)) +
  geom_point() +
  labs(title = "Best vs. Worst Carrier",x="Carriers", y="Total_Delay_Percentage") +
