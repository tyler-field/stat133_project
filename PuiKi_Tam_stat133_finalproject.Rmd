...
ggplot(Busy25Region, aes(x = ORIGIN, y = DelayPercentage, color=Region)) +
  ...
  labs(title = "Departure Delay of flights from the 25 Busiet US Airports in January 2017", x = "Origin Airports", y = "% of Delayed flights/Total flights took off") +
  theme(plot.title = element_text(size = 12.5, color = "gray4"),  
       axis.title.x = element_text(size = 10, color = "slateblue3"),  
        axis.title.y = element_text(size = 10, color = "violetred4"))
